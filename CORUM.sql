Begin;
    CREATE TABLE complexinfo (
        complexid PRIMARY KEY AUTOINCREMENT,
    ...
    CREATE TABLE untereinheiten (
        subid PRIMARY KEY AUTOINCREMENT,
        name VARCHAR(250) NOT NULL,
        organismus VARCHAR(250( NOT NULL,
    ...
    CREATE TABLE funktion (
        funid PRIMARY KEY AUTOINCREMENT,
        complex_id INTEGER NOT NULL,
            FOREIGN KEY (complex_id) REFERENCES complexinfo(complexid),
    ...
    CREATE TABLE funcat (
        funcatid PRIMARY KEY AUTOINCREMENT,
        fundescription VARCHAR(250) NOT NULL
        );

    CREATE TABLE go (
        goid PRIMARY KEY AUTOINCREMENT,
        godescription VARCHAR(250) NOT NULL
        );

    CREATE TABLE publikation (
        pubid PRIMARY KEY AUTOINCREMENT,
